...
st.markdown("""
<div class='calm-card'>
<h3>🎧 Reproductores tranquilos</h3>
<p>Elige un sonido ya preparado. No tienes que buscar ni comparar opciones.</p>
<p>Toca play una vez, baja el brillo y deja el teléfono a un lado.</p>
</div>
""", unsafe_allow_html=True)
